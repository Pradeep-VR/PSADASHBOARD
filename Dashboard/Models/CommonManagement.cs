...
namespace Dashboard.Models
{
    public class CommonManagement
    {
        ...
        public string GetConsumptions(string Id, string fd, string td, string lol)
        {
            ...
            string qry2 = "SELECT ACTIVEENERGYDELIVERED AS kwh ,SYNCDATETIME FROM TBL_ENERGYMETER WHERE " + lols + " AND CONVERT(DATETIME, SYNCDATETIME,103) " +
                "BETWEEN CONVERT(DATETIME, '" + fd + "',103) AND  CONVERT(DATETIME, '" + td + "',103)  ORDER BY SYNCDATETIME ASC";
